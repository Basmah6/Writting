...
import { PenTool, Keyboard, EyeOff, MoveLeft, Headphones, Eye, Sparkles, Volume2, Award, ArrowLeft, CheckCircle2, BookOpen, Maximize2, Minimize2, Lock, ShieldAlert, X, ChevronLeft, ChevronRight, ChevronDown, ChevronUp, Grid } from 'lucide-react';
